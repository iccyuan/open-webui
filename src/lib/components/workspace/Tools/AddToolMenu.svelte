...
>
	...
	<div slot="content">
		<DropdownMenu.Content
			class="w-full max-w-[190px] rounded-2xl px-1 py-1 border border-gray-200/60  dark:border-gray-700/60 z-50 bg-white/70 dark:bg-gray-850/70 dark:text-white shadow-lg"
			sideOffset={6}
			side="bottom"
			align="start"
