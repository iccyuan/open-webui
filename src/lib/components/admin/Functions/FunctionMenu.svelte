...
>
	...
	<div slot="content">
		<DropdownMenu.Content
			class="w-full max-w-[180px] rounded-xl p-1 border border-gray-200/60  dark:border-gray-700/60 z-50 bg-white/70 dark:bg-gray-850/70 dark:text-white shadow-sm"
			sideOffset={-2}
			side="bottom"
			align="start"
