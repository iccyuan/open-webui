...
{#if $showSidebar}
	<div
		...
		class="h-screen max-h-[100dvh] min-h-screen select-none {$showSidebar
			? `${$mobile ? 'bg-gray-50/85 dark:bg-gray-950/85 backdrop-blur-md' : 'bg-gray-50/30 dark:bg-gray-950/30 glass-blur'} z-50`
		...
		>
			...
			>
				...
				<div
					class="{scrollTop > 0
						? 'visible'
						: 'invisible'} sidebar-bg-gradient-to-b bg-linear-to-b from-gray-50/60 dark:from-gray-950/60 to-transparent from-50% pointer-events-none absolute inset-0 -z-10 -mb-6"
				></div>
			</div>
			...
			<div class="px-1.5 pt-1.5 pb-2 sticky bottom-0 z-10 -mt-3 sidebar">
				<div
					class=" sidebar-bg-gradient-to-t bg-linear-to-t from-gray-50/60 dark:from-gray-950/60 to-transparent from-50% pointer-events-none absolute inset-0 -z-10 -mt-6"
				></div>
